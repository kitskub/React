...
public class ContactManifold {
	...
	public void addContactPoint(ContactPoint contact) {
		for (int i = 0; i < mNbContactPoints; i++) {
			final float distance = mContactPoints[i].getWorldPointOnFirstBody().sub(
					contact.getWorldPointOnFirstBody()).lengthSquared();
	...
	public void update(Transform transform1, Transform transform2) {
		...
		for (int i = 0; i < mNbContactPoints; i++) {
			...
			mContactPoints[i].setPenetrationDepth(mContactPoints[i].getWorldPointOnFirstBody().sub(mContactPoints[i]
